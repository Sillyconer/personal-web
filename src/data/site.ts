...
export const ecosystemGraph: EcosystemGraphDefinition = {
  nodes: [
    {
      id: 'personalweb',
      label: 'PersonalWeb',
      ...
      x: 28,
      y: 28,
      description: 'The portfolio shell itself: public-facing, case-study driven, and designed to hold the wider project ecosystem together.',
      accent: 'red',
      href: '/work/personalweb',
    },
    {
      id: 'mapper',
      label: 'Mapper',
      ...
      x: 70,
      y: 28,
      description: 'A map-first platform for travel, media, and memory with room for private views and deeper product expansion.',
      accent: 'blue',
      href: '/work/mapper',
    },
    {
      id: 'solo-build',
      label: 'Solo / Self-directed',
      type: 'collab',
      x: 16,
      y: 64,
      description: 'Current flagship work is self-directed, which keeps the visual and product language tightly authored.',
      accent: 'yellow',
    },
    {
      id: 'product-teams',
      ...
      x: 48,
      y: 78,
      description: 'The sweet spot for collaboration: teams that need a sharper interface system and stronger product presentation.',
      accent: 'teal',
    },
    {
      id: 'frontend-systems',
      ...
      x: 84,
      y: 62,
      description: 'Reusable architecture, interaction language, and implementation discipline that can survive real growth.',
      accent: 'blue',
    },
    {
      id: 'retro-signal',
  ...
  edges: [
    { from: 'personalweb', to: 'mapper', label: 'flagship system link' },
    { from: 'personalweb', to: 'solo-build', label: 'currently built as' },
    { from: 'mapper', to: 'solo-build', label: 'currently built as' },
    { from: 'personalweb', to: 'product-teams', label: 'made to attract' },
    { from: 'mapper', to: 'frontend-systems', label: 'driven by' },
    { from: 'personalweb', to: 'frontend-systems', label: 'organized by' },
    { from: 'personalweb', to: 'retro-signal', label: 'presented through' },
    { from: 'mapper', to: 'retro-signal', label: 'influences the shell' },
    { from: 'product-teams', to: 'frontend-systems', label: 'best fit for' },
  ],
};
